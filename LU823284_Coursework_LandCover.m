...
GT = importdata('ground_truth.mat');

%Display GT as Image Plot with different colours
figure(1)
imagesc(GT);
colormap(hot);
axis equal;
...
b = imread('b.bmp','BMP');
fe = imread('fe.bmp','BMP');
g = imread('g.bmp','BMP');
le = imread('le.bmp','BMP');
nir = imread('nir.bmp','BMP');
r = imread('r.bmp','BMP');
...
%Create More Buildings to address under clasification
%B21(66,108)
B21_Y =66;
B21_X=108;
b_21_b = double(b(B21_Y,B21_X));
b_21_fe = double(fe(B21_Y,B21_X));
b_21_g = double(g(B21_Y,B21_X));
b_21_le = double(le(B21_Y,B21_X));
b_21_nir = double(nir(B21_Y,B21_X));
b_21_r = double(r(B21_Y,B21_X));

%B22(63,39)
B22_Y =63;
B22_X=39;
b_22_b = double(b(B22_Y,B22_X));
b_22_fe = double(fe(B22_Y,B22_X));
b_22_g = double(g(B22_Y,B22_X));
b_22_le = double(le(B22_Y,B22_X));
b_22_nir = double(nir(B22_Y,B22_X));
b_22_r = double(r(B22_Y,B22_X));

%B23(151,5)
B23_Y =151;
B23_X=5;
b_23_b = double(b(B23_Y,B23_X));
b_23_fe = double(fe(B23_Y,B23_X));
b_23_g = double(g(B23_Y,B23_X));
b_23_le = double(le(B23_Y,B23_X));
b_23_nir = double(nir(B23_Y,B23_X));
b_23_r = double(r(B23_Y,B23_X));

%B24(168,234)
B24_Y =168;
B24_X=234;
b_24_b = double(b(B24_Y,B24_X));
b_24_fe = double(fe(B24_Y,B24_X));
b_24_g = double(g(B24_Y,B24_X));
b_24_le = double(le(B24_Y,B24_X));
b_24_nir = double(nir(B24_Y,B24_X));
b_24_r = double(r(B24_Y,B24_X));

%B25(167,238)
B25_Y =167;
B25_X=238;
b_25_b = double(b(B25_Y,B25_X));
b_25_fe = double(fe(B25_Y,B25_X));
b_25_g = double(g(B25_Y,B25_X));
b_25_le = double(le(B25_Y,B25_X));
b_25_nir = double(nir(B25_Y,B25_X));
b_25_r = double(r(B25_Y,B25_X));

%B26(34,110)
B26_Y =34;
B26_X=110;
b_26_b = double(b(B26_Y,B26_X));
b_26_fe = double(fe(B26_Y,B26_X));
b_26_g = double(g(B26_Y,B26_X));
b_26_le = double(le(B26_Y,B26_X));
b_26_nir = double(nir(B26_Y,B26_X));
b_26_r = double(r(B26_Y,B26_X));

%B27(167,240)
B27_Y =167;
B27_X=240;
b_27_b = double(b(B27_Y,B27_X));
b_27_fe = double(fe(B27_Y,B27_X));
b_27_g = double(g(B27_Y,B27_X));
b_27_le = double(le(B27_Y,B27_X));
b_27_nir = double(nir(B27_Y,B27_X));
b_27_r = double(r(B27_Y,B27_X));

%B28(182,275)
B28_Y =182;
B28_X=275;
b_28_b = double(b(B28_Y,B28_X));
b_28_fe = double(fe(B28_Y,B28_X));
b_28_g = double(g(B28_Y,B28_X));
b_28_le = double(le(B28_Y,B28_X));
b_28_nir = double(nir(B28_Y,B28_X));
b_28_r = double(r(B28_Y,B28_X));

%B29(6,245)
B29_Y =6;
B29_X=245;
b_29_b = double(b(B29_Y,B29_X));
b_29_fe = double(fe(B29_Y,B29_X));
b_29_g = double(g(B29_Y,B29_X));
b_29_le = double(le(B29_Y,B29_X));
b_29_nir = double(nir(B29_Y,B29_X));
b_29_r = double(r(B29_Y,B29_X));

%B30(2,180)
B30_Y =2;
B30_X=180;
b_30_b = double(b(B30_Y,B30_X));
b_30_fe = double(fe(B30_Y,B30_X));
b_30_g = double(g(B30_Y,B30_X));
b_30_le = double(le(B30_Y,B30_X));
b_30_nir = double(nir(B30_Y,B30_X));
b_30_r = double(r(B30_Y,B30_X));

BV21 = [b_21_b b_21_fe b_21_g b_21_le b_21_nir b_21_r];
BV22 = [b_22_b b_22_fe b_22_g b_22_le b_22_nir b_22_r];
BV23 = [b_2_b b_2_fe b_2_g b_2_le b_2_nir b_2_r];
BV24 = [b_3_b b_3_fe b_3_g b_3_le b_3_nir b_3_r];
BV25 = [b_4_b b_4_fe b_4_g b_4_le b_4_nir b_4_r];
BV26 = [b_5_b b_5_fe b_5_g b_5_le b_5_nir b_5_r];
BV27 = [b_6_b b_6_fe b_6_g b_6_le b_6_nir b_6_r];
BV28 = [b_7_b b_7_fe b_7_g b_7_le b_7_nir b_7_r];
BV29 = [b_8_b b_8_fe b_8_g b_8_le b_8_nir b_8_r];
BV30 = [b_9_b b_9_fe b_9_g b_9_le b_9_nir b_9_r];

%Building Matrix
BM = [BM;BV21;BV22;BV23;BV24;BV25;BV26;BV27;BV28;BV29;BV30];

%Calculate the Building Mean
BMean = mean(BM);
%BVM = (BV1 + BV2 + BV3 + BV4)/4;

%Get the Building Variance
%BVar = std(BVM).^2;
BVar = cov(BM);
...
%Calculate the Veg Mean
%VVM = (VV1 + VV2 + VV3 + VV4)/4;
VMean = mean(VM);

%Get the Veg Variance
%VegVar = std(VVM).^2;
VVar = cov(VM);
...
%Additional Ground after under classification
%G21(185,179)
G21_Y = 185;
G21_X = 179;
g_21_b = double(b(G21_Y,G21_X));
g_21_fe = double(fe(G21_Y,G21_X));
g_21_g = double(g(G21_Y,G21_X));
g_21_le = double(le(G21_Y,G21_X));
g_21_nir = double(nir(G21_Y,G21_X));
g_21_r = double(r(G21_Y,G21_X));

%G22(10,34)
G22_Y = 10;
G22_X = 34;
g_22_b = double(b(G22_Y,G22_X));
g_22_fe = double(fe(G22_Y,G22_X));
g_22_g = double(g(G22_Y,G22_X));
g_22_le = double(le(G22_Y,G22_X));
g_22_nir = double(nir(G22_Y,G22_X));
g_22_r = double(r(G22_Y,G22_X));

%G23(182,15)
G23_Y = 182;
G23_X = 15;
g_23_b = double(b(G23_Y,G23_X));
g_23_fe = double(fe(G23_Y,G23_X));
g_23_g = double(g(G23_Y,G23_X));
g_23_le = double(le(G23_Y,G23_X));
g_23_nir = double(nir(G23_Y,G23_X));
g_23_r = double(r(G23_Y,G23_X));

%G24(44,286)
G24_Y = 44;
G24_X = 286;
g_24_b = double(b(G24_Y,G24_X));
g_24_fe = double(fe(G24_Y,G24_X));
g_24_g = double(g(G24_Y,G24_X));
g_24_le = double(le(G24_Y,G24_X));
g_24_nir = double(nir(G24_Y,G24_X));
g_24_r = double(r(G24_Y,G24_X));

%G25(18,230)
G25_Y = 18;
G25_X = 230;
g_25_b = double(b(G25_Y,G25_X));
g_25_fe = double(fe(G25_Y,G25_X));
g_25_g = double(g(G25_Y,G25_X));
g_25_le = double(le(G25_Y,G25_X));
g_25_nir = double(nir(G25_Y,G25_X));
g_25_r = double(r(G25_Y,G25_X));

%G26(159,256)
G26_Y = 159;
G26_X = 256;
g_26_b = double(b(G26_Y,G26_X));
g_26_fe = double(fe(G26_Y,G26_X));
g_26_g = double(g(G26_Y,G26_X));
g_26_le = double(le(G26_Y,G26_X));
g_26_nir = double(nir(G26_Y,G26_X));
g_26_r = double(r(G26_Y,G26_X));

%G27(183,190)
G27_Y = 183;
G27_X = 190;
g_27_b = double(b(G27_Y,G27_X));
g_27_fe = double(fe(G27_Y,G27_X));
g_27_g = double(g(G27_Y,G27_X));
g_27_le = double(le(G27_Y,G27_X));
g_27_nir = double(nir(G27_Y,G27_X));
g_27_r = double(r(G27_Y,G27_X));

%G28(140,326)
G28_Y = 140;
G28_X = 326;
g_28_b = double(b(G28_Y,G28_X));
g_28_fe = double(fe(G28_Y,G28_X));
g_28_g = double(g(G28_Y,G28_X));
g_28_le = double(le(G28_Y,G28_X));
g_28_nir = double(nir(G28_Y,G28_X));
g_28_r = double(r(G28_Y,G28_X));

%G29(65,108)
G29_Y = 65;
G29_X = 108;
g_29_b = double(b(G29_Y,G29_X));
g_29_fe = double(fe(G29_Y,G29_X));
g_29_g = double(g(G29_Y,G29_X));
g_29_le = double(le(G29_Y,G29_X));
g_29_nir = double(nir(G29_Y,G29_X));
g_29_r = double(r(G29_Y,G29_X));

%G30(89,30)
G30_Y = 89;
G30_X = 30;
g_30_b = double(b(G30_Y,G30_X));
g_30_fe = double(fe(G30_Y,G30_X));
g_30_g = double(g(G30_Y,G30_X));
g_30_le = double(le(G30_Y,G30_X));
g_30_nir = double(nir(G30_Y,G30_X));
g_30_r = double(r(G30_Y,G30_X));

%Add More GMs

GV21 = [g_21_b g_21_fe g_21_g g_21_le g_21_nir g_21_r];
GV22 = [g_22_b g_22_fe g_22_g g_22_le g_22_nir g_22_r];
GV23 = [g_23_b g_23_fe g_23_g g_23_le g_23_nir g_23_r];
GV24 = [g_24_b g_24_fe g_24_g g_24_le g_24_nir g_24_r];
GV25 = [g_25_b g_25_fe g_25_g g_25_le g_25_nir g_25_r];
GV26 = [g_26_b g_26_fe g_26_g g_26_le g_26_nir g_26_r];
GV27 = [g_27_b g_27_fe g_27_g g_27_le g_27_nir g_27_r];
GV28 = [g_28_b g_28_fe g_28_g g_28_le g_28_nir g_28_r];
GV29 = [g_29_b g_29_fe g_29_g g_29_le g_29_nir g_29_r];
GV30 = [g_30_b g_30_fe g_30_g g_30_le g_30_nir g_30_r];

GM = [GM; GV21; GV22; GV23; GV24; GV25; GV26; GV27; GV28; GV29; GV30];

%Calculate the Ground Mean

GMean = mean(GM);

%Get the Ground Variance
%GVar = std(GVM).^2;
GVar = cov(GM);
...
for num_rows = 1:211
    for num_cols = 1:356
       ...
       PV = [bp fep gp lep nirp rp];
       
       %Now run the probability function for each
       P1 = probability(PV,BMean,BVar);
       P2 = probability(PV,VMean,VVar);
       P3 = probability(PV, CMean, CVar);
       P4 = probability(PV, GMean, GVar);
       ...
       MOut(num_rows,num_cols) = V;
    end
end

%Show the Images
%Display Results as Image Plot with different colours
figure(2)
imagesc(MOut);
colormap(hot);
axis equal;
...
h.Visible = 'On';
figure(4)
C= confusionmat(transpose(GT(:)),transpose(MOut(:)));
confusionchart(C);
...
%Plot the Gausian Functions
%BR = random_nums(BV1(1),BVar);
%CR = random_nums(CVM(1),CarVar);
%VR = random_nums(VVM(1),VegVar);
%GR = random_nums(GVM(1),GVar);
%figure(2)
%histogram(BR);
%hold on
%histogram(VR);
...
%p1 = 1 /(((2*pi)^10)*sqrt(det(va))); - Not needed
